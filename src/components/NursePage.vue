...
const fetchOptions = async () => {
  try {
    ...
    const promises = categories.map(category =>
      fetch(`http://localhost:3000/api/options/${category}`)
...
const startEditing = (patient) => {
  ...
  editedPatient.substance_use = Array.isArray(patient.substance_use) ? [...patient.substance_use] : []
  editedPatient.family_history = Array.isArray(patient.family_history) ? [...patient.family_history] : []
              ...
              <div class="space-y-8">
                ...
                <div>
                  ...
                  <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <!-- Edit Mode -->
                    <div v-else class="space-y-4">
                      <label class="block text-sm font-medium text-gray-700 mb-1">Select Allergies</label>
                      <div class="bg-white p-4 rounded border border-gray-300 max-h-60 overflow-y-auto">
                        <div class="grid grid-cols-2 gap-2">
                          <div v-for="option in allergyOptions" :key="option" class="flex items-center">
                            <input
                              type="checkbox"
                              :id="'allergy-' + option"
                              :value="option"
                            ...
                            >
                            <label :for="'allergy-' + option" class="ml-2 text-sm text-gray-700">{{ option }}</label>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div class="bg-gray-50 rounded-lg p-6">
                    <!-- View Mode -->
                    <div v-if="!isEditing">
                      <div v-if="selectedPatient.substance_use?.length" class="flex flex-wrap gap-2">
                        <span
                    ...
                    <!-- Edit Mode -->
                    <div v-else class="space-y-4">
                      <label class="block text-sm font-medium text-gray-700 mb-1">Select Substance Use</label>
                      <div class="bg-white p-4 rounded border border-gray-300">
                        <div class="space-y-2">
                          <div v-for="option in substanceUseOptions" :key="option" class="flex items-center">
                            <input
                              type="checkbox"
                              :id="'substance-' + option"
                              :value="option"
                              ...
                              class="h-4 w-4 text-blue-600 focus:ring-blue-500 rounded"
                            >
                            <label :for="'substance-' + option" class="ml-2 text-sm text-gray-700">{{ option }}</label>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div class="bg-gray-50 rounded-lg p-6">
                    <!-- View Mode -->
                    <div v-if="!isEditing">
                      <div v-if="selectedPatient.family_history?.length" class="flex flex-wrap gap-2">
                        <span
                    ...
                    <!-- Edit Mode -->
                    <div v-else class="space-y-4">
                      <label class="block text-sm font-medium text-gray-700 mb-1">Select Family History</label>
                      <div class="bg-white p-4 rounded border border-gray-300 max-h-60 overflow-y-auto">
                        <div class="grid grid-cols-2 gap-2">
                          <div v-for="option in familyHistoryOptions" :key="option" class="flex items-center">
                            <input
                              type="checkbox"
                              :id="'family-' + option"
                              :value="option"
                              ...
                              class="h-4 w-4 text-blue-600 focus:ring-blue-500 rounded"
                            >
                            <label :for="'family-' + option" class="ml-2 text-sm text-gray-700">{{ option }}</label>
                          </div>
                        </div>
                      </div>
                    </div>
